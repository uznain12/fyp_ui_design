...
class GuardmanageAttendnace extends StatefulWidget {
  const GuardmanageAttendnace({super.key});

  @override
  State<GuardmanageAttendnace> createState() => _GuardmanageAttendnaceState();
}
...
class _GuardmanageAttendnaceState extends State<GuardmanageAttendnace> {
  String gval = "none";
  @override
